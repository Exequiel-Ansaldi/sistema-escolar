...
export const api = {
  ...
  getAllAlumnos: async () => (await request<PaginatedResult<any>>('/alumnos?limit=9999')).data,
  ...
  getAllCursos: async () => (await request<PaginatedResult<any>>('/cursos?limit=9999')).data,
  ...
  getAllDocentes: async () => (await request<PaginatedResult<any>>('/docentes?limit=9999')).data,
  ...
  getAllMaterias: async () => (await request<PaginatedResult<any>>('/materias?limit=9999')).data,
