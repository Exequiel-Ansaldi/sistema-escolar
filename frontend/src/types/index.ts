...
export interface Materia { id: number; nombre: string; cargaHoraria: number; }
...
export interface Acuerdo { id: number; alumnoId: number; fecha: string; descripcion: string; estado: string; }
...
export interface Licencia { id: number; docenteId: number; fechaInicio: string; fechaFin: string; motivo: string; estado: string; observacion?: string; }
export interface Horario { id: number; docenteId: number; cursoId: number; materiaId: number; horaInicio: string; diaSemana: string; horaFin: string; docente?: Docente; materia?: Materia; curso?: Curso; }
